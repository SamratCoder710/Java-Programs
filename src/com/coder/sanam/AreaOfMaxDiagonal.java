...
public class AreaOfMaxDiagonal {
    ...
    public static void main(String[] args) {
        ...
        AreaOfMaxDiagonal obj = new AreaOfMaxDiagonal();
    ...
    public int areaOfMaxDiagonal(int[][] dimensions) {
        ...
        for (int[] arr : dimensions) {
            ...
            int breadth = arr[1];
            int area;
            int diagonalSquare = (len * len + breadth * breadth);

            if (diagonalSquare > maxValue) {
                maxValue = diagonalSquare;
                area = len * breadth;
                maxArea = area;
            } else if (diagonalSquare == maxValue) {
                area = len * breadth;
